  ...
  <div class="swiper-container">
    ...
    <div class="swiper-wrapper">
		...
		if(mysqli_num_rows($run)>0)
		{
			...
			{
				if($row['Release_date']>='2022-12-10')
				{
				?>
	  ...
	  <tr>
		...
		<center>
		<img height="400px" width="340px"  src="images/<?php echo $row['poster']?>"> 
		</center>
		</div>
        ...
        <iframe width="900" height="400" src="https://www.youtube.com/embed/<?php echo $row['trailer']; ?>" 
		...
		<td style="position:absolute;top:670px;left:80px">
				...
				<center>
					...
					<img src="images/<?php echo $row['ActorImg']?>" height="220px"width="150px" style="border-radius: 10px"/> 
		...
		<td style="position:absolute;top:670px;left:380px">
				<center>
					<p>ACTRESS</p>
					<img src="images/<?php echo $row['ActressImg']?>" height="220px"width="150px" style="border-radius: 10px"/>
		...
		<td style="position:absolute;top:670px;left:680px">
				<center>
					<p>DIRECTOR</p>
					<img src="images/<?php echo $row['DirectorImg']?>"height="220px"width="150px" style="border-radius: 10px"/> 
