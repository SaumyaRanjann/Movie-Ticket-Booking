  ...
  <span class="close" onclick="location.href='userdashboard.php'">&times;</span>
	...
	<table width="auto" height="1200px" >
	  <tr>
		...
		<center>
		<img height="400px" width="340px"  src="images/<?php echo $row1['poster']?>"> 
		</center>
		...
		<td style="position:absolute;top:40px;right:40px">
				...
				<iframe width="900" height="400" src="https://www.youtube.com/embed/<?php echo $row1['trailer']; ?>" 
		...
		<h2 style="position:absolute;top:620px;left:180px;">CAST</h2>
		<td style="position:absolute;top:670px;left:80px">
				...
				<p>ACTOR</p>
					...
					<img src="images/<?php echo $row1['ActorImg']?>" height="220px"width="150px" style="border-radius: 10px"/> 
		...
		<td style="position:absolute;top:670px;left:380px">
				<center>
					<p>ACTRESS</p>
					<img src="images/<?php echo $row1['ActressImg']?>" height="220px"width="150px" style="border-radius: 10px"/>
		...
		<td style="position:absolute;top:670px;left:680px">
				<center>
					<p>DIRECTOR</p>
					<img src="images/<?php echo $row1['DirectorImg']?>"height="220px"width="150px" style="border-radius: 10px"/> 
  ...
  <span class="close" onclick="location.href='userdashboard.php'">&times;</span>
	...
	<table width="auto" height="1200px" >
	  <tr>
		...
		<tr>
		<h2 style="position:absolute;top:620px;left:80px;text-align: center;">CAST</h2>
		<td style="position:absolute;top:670px;left:80px">
				<center>
				<p>ACTOR</p>
