...
<div class="swiper-container">
    ...
    <div class="swiper-slide" style="border-radius: 18px;">
	<div class="imgBx">
        <?php
        $imagePath = "images/" . $row1['poster'];
        if (file_exists($imagePath)) {
            echo '<img src="' . $imagePath . '" width="300px" height="300px">';
        } else {
...
<h2 style="position:absolute;left:30px;top:1150px">MYSTERY/ACTION<i class="right"></i></h2>

<h2 style="position:absolute;left:30px;top:1590px">HORROR/THRLLER/CRIME<i class="right"></i></h2>
...
<div class="movie-list">
 ...
 <table height="1300px" width="100%">
        ...
        $qry = "select * from movies where type like '%comedy%'";
		...
		<img height="300px" width="300px" style="transition:0.75s;border-radius:20px;" src="images/<?php echo $row['poster'];?>"> 
					 </a>
					 </div>
        ...
        $qry = "select * from movies where type like '%mystery%' or type like '%action%'";
        ...
        $qry = "select * from movies where type like '%horror%' or type like '%thriller%' or type like '%crime%'";
