...
<body>
	<div class="title">
			<h3 align="right" style="margin-right:20px;"><a href="index.php">Customer Login</a></h3>
	...
	<div class="loginbox">
		...
		<form action="admin.php" method="post" class="animated flipInY">
			<p>Admin-Id</p>
			<input type="text" name="admin_name" placeholder="Enter Admin-Id">
			
			<p>Password</p>
			<input type="password" name="password1" placeholder="Enter Admin_Password"><br>
